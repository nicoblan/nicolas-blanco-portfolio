  ...
  return (
    <section id="contacto" className="py-0">
      <div className="text-center max-w-2xl mx-auto">
        <h3 className={`text-3xl font-bold hb-item ${mounted ? 'hb-enter' : ''}`} style={{ transitionDelay: mounted ? '120ms' : '0ms' }}>Contacto</h3>
        ...
        <div className="mt-8 flex flex-col items-center gap-6">
          {/* Ubicación */}
          <div className={`flex flex-col items-center gap-1 hb-item ${mounted ? 'hb-enter' : ''}`} style={{ transitionDelay: mounted ? '320ms' : '0ms' }}>
          ...
          {/* Email */}
          <div className={`flex flex-col items-center gap-1 hb-item from-right ${mounted ? 'hb-enter' : ''}`} style={{ transitionDelay: mounted ? '420ms' : '0ms' }}>
            <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* LinkedIn */}
          <div className={`flex flex-col items-center gap-1 hb-item ${mounted ? 'hb-enter' : ''}`} style={{ transitionDelay: mounted ? '520ms' : '0ms' }}>
            <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          {/* Teléfono */}
          <div className={`flex flex-col items-center gap-1 hb-item from-right ${mounted ? 'hb-enter' : ''}`} style={{ transitionDelay: mounted ? '620ms' : '0ms' }}>
            <div className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
